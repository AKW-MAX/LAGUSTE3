...
export default function SignUp() { 
    ...
    <> 
        ...
        <div className="relative"> 
            {/* Image */} 
            <img className="
            w-64 h-52 sm:w-80 sm:h-64 absolute p-6 left-0 sm:left-auto" 
            ...
            <div className="text-justify text-white bg-green-900 pr-4 pl-4 pb-12 pt-8 mt-4 sm:mt-4"> 
                ...
                <input type="email" placeholder="Enter your email" className="text-black text-center rounded-lg pr-20 pb-2 ml-0 sm:ml-150 bg-white mt-4 w-full sm:w-64" /> 
