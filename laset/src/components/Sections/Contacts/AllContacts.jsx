    ...
    return (
        ...
        <div>
            ...
            <div className="flex items-center">
                <img className="w-4 bg-white md:w-3 lg:w-5 ml-15" src={PhoneIcon} alt="phone icon" />
        ...
        <div>
            <div className="flex items-center">
                ...
                <a href="http://whatsapp.com/biz/0704519867">
                    <img className="w-4 bg-white md:w-3 lg:w-5 ml-15 " src={WhatsappIcon} alt="whatsapp icon" /></a>
                </p>
        ...
        <div>
            <div className="flex items-center">
                <p>
                    ...
                    <img className="w-4 bg-white md:w-3 lg:w-5 ml-15  " src={FacebookIcon} /></a>
                </p>
