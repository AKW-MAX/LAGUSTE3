    ...
    return (
        ...
        <div>
            ...
            <div className="flex items-center">
                <img className="w-4 bg-white md:w-3 lg:w-5 ml-15" src={assets.phone} alt="phone icon" />
        ...
        <div>
            <div className="flex items-center">
                ...
                <a href="http://whatsapp.com/biz/0704519867">
                    <img className="w-4 bg-white md:w-3 lg:w-5 ml-15 " src={assets.whatsapp} alt="whatsapp icon" /></a>
                </p>
        ...
        <div>
            <div className="flex items-center">
                <p>
                    ...
                    <img className="w-4 bg-white md:w-3 lg:w-5 ml-15  " src={assets.facebook} /></a>
                </p>
